    ...
    <div class="container mx-auto px-4 py-8">
        <form action="{{ route('collection.store') }}" method="POST"  enctype="multipart/form-data" class="bg-white shadow-md rounded-lg px-8 py-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                {{-- images --}}
                <div class="col-span-2">
                    <label for="images" class="block font-bold mb-2">Images (Max 2MB per image)</label>
                ...
                {{-- file --}}
                <div class="col-span-2">
                    <label for="file" class="block font-bold mb-2">File (Max 2MB)</label>
                    <input type="file" name="file" id="file" class="w-full border rounded-md py-2 px-3">
                </div>
                {{-- PDF --}}
                <div class="col-span-2">
                    <label for="pdf" class="block font-bold mb-2">PDF (Max 2MB)</label>
